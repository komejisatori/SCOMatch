...
def set_parser():
    ...
    parser.add_argument('--num-labeled', type=int, default=400,
                        choices=[10, 25, 50, 100, 150, 300, 400],
                        help='number of labeled data per each class')
    parser.add_argument('--ratio', type=float, default=0.6,
                        help='ratio of unseen unlabeled data')
    ...
    parser.add_argument('--arch', default='wideresnet', type=str,
                        choices=['wideresnet', 'resnext',
                                 'resnet_imagenet','Competing_wideresnet', 'Competing_vit','SCOMatch_wideresnet','Competing_resnet_imagenet', 'cnn'],
                        help='dataset name')
    ...
    parser.add_argument('--ood-threshold', default=0.0, type=float,
                        help='ood pseudo label threshold')
    ##
    ...
    parser.add_argument('--Km', default=1, type=int,
                        help='samples enqueue per iter')
