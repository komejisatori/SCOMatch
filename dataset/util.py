...
class TinyImageFolder(data.Dataset):
    def __init__(self, image_list, label_list, root='data/tiny-imagenet/', transform=None, target_transform=None, return_paths=False,
